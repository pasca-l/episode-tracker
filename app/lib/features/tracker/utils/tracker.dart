...
void sortRecordsByTitle(List<Record> records, bool ascending) {
  if (ascending) {
...
void sortRecordsByEnglishTitle(List<Record> records, bool ascending) {
  ...
  if (ascending) {
    records.sort(
        (a, b) => sanitize(a.titleEnglish).compareTo(sanitize(b.titleEnglish)));
  } else {
    records.sort(
        (a, b) => sanitize(b.titleEnglish).compareTo(sanitize(a.titleEnglish)));
  }
}

void sortRecordsByEpisode(List<Record> records, bool ascending) {
  if (ascending) {
...
void sortRecordsByAiredFrom(List<Record> records, bool ascending) {
  if (ascending) {
